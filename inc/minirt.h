...
/*   Updated: 2024/04/25 00:12:37 by sgundogd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			assign_cy_vectors(const t_ray *ray,
					const t_cylinder *cy, t_cy_vec *d);
void			find_x1(const t_ray *ray, const t_cylinder *cy, t_cy_vec *data);
void			find_x2_x3(const t_ray *ray, const t_cylinder *cy, t_cy_vec *d);
